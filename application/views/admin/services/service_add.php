            ...
            <div class="panel-body panel-admin">
                <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group"> 
                        ...
                        <input type="text" name='service_name' value="<?=set_value('service_name')?>" class="form-control"><h5 style="color:red;"><?=form_error('service_name')?></h5><br>

                      </div>
                      
                      <div class="form-group"> 
                        <label for="inputID" class="col-sm-12">Шарҳ *</label>
                        <textarea name="service_short" id="" cols="70"  rows="8" value=""><?=set_value('service_short')?></textarea><h5 style="color:red;"><?=form_error('service_short')?></h5><br>
                      </div>
                       <div class="form-group"> 
