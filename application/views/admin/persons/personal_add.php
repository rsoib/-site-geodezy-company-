            ...
            <div class="panel-body panel-admin">
                <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group"> 
                        ...
                        <input type="text" name='person_name' value="<?=set_value('person_name')?>" class="form-control"><h5 style="color:red;"><?=form_error('person_name')?></h5><br>

                      </div>

                      <div class="form-group"> 
                        <label for="inputID" class="col-sm-12">Шарҳ *</label>
                        <textarea name="person_text" id="" cols="40"  rows="8" value=""><?=set_value('person_text')?></textarea><h5 style="color:red;"><?=form_error('person_text')?></h5><br>
                      </div>
