            ...
            <div class="panel-body panel-admin">
                <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group"> 
                        ...
                        <input type="text" name='news_title' value="<?=set_value('news_title')?>" class="form-control"><h5 style="color:red;"><?=form_error('news_title')?></h5><br>

                      </div>

                      <div class="form-group"> 
                        <label for="inputID" class="col-sm-12">Матни кӯтоҳ *</label>
                        <textarea name="news_short" id="" cols="70"  rows="8" value=""><?=set_value('news_short')?></textarea><h5 style="color:red;"><?=form_error('news_short')?></h5><br>
                      </div>
    
                      <div class="form-group"> 
                        <label for="inputID" class="col-sm-12">Матни пурра *</label>
                         <textarea class="form-control" rows="7" name="news_content" data-validation-optional="true" value=""><?=set_value('news_content')?></textarea><h5 style="color:red;"><?=form_error('news_content')?></h5><br>
                      </div>
