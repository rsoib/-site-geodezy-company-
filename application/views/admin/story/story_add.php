            ...
            <div class="panel-body panel-admin">
                <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group"> 
                        ...
                        <input type="text" name='history_title' value="<?=set_value('history_title')?>" class="form-control"><h5 style="color:red;"><?=form_error('history_title')?></h5><br>

                      </div>

                      <div class="form-group"> 
                        <label for="inputID" class="col-sm-12">Матни пурра *</label>
                         <textarea class="form-control" rows="7" name="history_text" data-validation-optional="true" value=""><?=set_value('history_text')?></textarea><h5 style="color:red;"><?=form_error('history_text')?></h5><br>
                      </div>
